...
import { adminGetApi,adminPostApi,adminPatchApi,adminDeleteApi} from '../../../utils/apiHandler'
...
function NotificationForm(props) {
    ...
    const serverHandler = async(action) =>{
        ...
        switch (action) {
            case 'get':
                result = await adminGetApi({url:'/notifications',data:{...notification}})
                break;
            case 'create':
                result = await adminPostApi({url:'/notifications',data:{...notification}})
                break;
            case 'update':
                result = await adminPatchApi({url:'/notifications',data:{...notification,_id}})
                break;
            case 'delete':
                result = await adminDeleteApi({url:'/notifications',data:{_id}})
                break;
            default:
                break;
        }
